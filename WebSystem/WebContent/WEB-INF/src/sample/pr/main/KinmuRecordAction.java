...
//		oForm.setTec(oForm.getTec());
		...
		try{
			if(button.equals("戻る")){
				...
				String remark7 = request.getParameter("remark7");
				String remark8 = request.getParameter("remark8");
				String remark9 = request.getParameter("remark9");
				String remark10 = request.getParameter("remark10");
				String remark11 = request.getParameter("remark11");
				String remark12 = request.getParameter("remark12");
				String remark13 = request.getParameter("remark13");
				String remark14 = request.getParameter("remark14");
				String remark15 = request.getParameter("remark15");
				String remark16 = request.getParameter("remark16");
				String remark17 = request.getParameter("remark17");
				String remark18 = request.getParameter("remark18");
				String remark19 = request.getParameter("remark19");
				String remark20 = request.getParameter("remark20");
				String remark21 = request.getParameter("remark21");
				String remark22 = request.getParameter("remark22");
				String remark23 = request.getParameter("remark23");
				String remark24 = request.getParameter("remark24");
				String remark25 = request.getParameter("remark25");
				String remark26 = request.getParameter("remark26");
				String remark27 = request.getParameter("remark27");
				String remark28 = request.getParameter("remark28");
				String remark29 = request.getParameter("remark29");
				String remark30 = request.getParameter("remark30");
				String remark31 = request.getParameter("remark31");
				//バッファー
...
//				KinmuRecordSendForm KRSForm = (KinmuRecordSendForm) frm;
				...
				if(!(holidayDiv1.equals("0")) || query1.length() > 1){
					...
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD1());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv1());
					KRSForm.setStartTime(KRForm.getStartTime1());
					KRSForm.setEndTime(KRForm.getEndTime1());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA1());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB1());
					KRSForm.setVacationDiv(KRForm.getVacationDiv1());
					KRSForm.setRemark(KRForm.getRemark1());
				...
				if(!(holidayDiv2.equals("0")) || query2.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD2());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv2());
					KRSForm.setStartTime(KRForm.getStartTime2());
					KRSForm.setEndTime(KRForm.getEndTime2());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA2());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB2());
					KRSForm.setVacationDiv(KRForm.getVacationDiv2());
					KRSForm.setRemark(KRForm.getRemark2());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv3.equals("0")) || query3.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD3());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv3());
					KRSForm.setStartTime(KRForm.getStartTime3());
					KRSForm.setEndTime(KRForm.getEndTime3());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA3());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB3());
					KRSForm.setVacationDiv(KRForm.getVacationDiv3());
					KRSForm.setRemark(KRForm.getRemark3());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv4.equals("0")) || query4.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD4());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv4());
					KRSForm.setStartTime(KRForm.getStartTime4());
					KRSForm.setEndTime(KRForm.getEndTime4());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA4());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB4());
					KRSForm.setVacationDiv(KRForm.getVacationDiv4());
					KRSForm.setRemark(KRForm.getRemark4());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv5.equals("0")) || query5.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD5());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv5());
					KRSForm.setStartTime(KRForm.getStartTime5());
					KRSForm.setEndTime(KRForm.getEndTime5());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA5());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB5());
					KRSForm.setVacationDiv(KRForm.getVacationDiv5());
					KRSForm.setRemark(KRForm.getRemark5());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv6.equals("0")) || query6.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD6());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv6());
					KRSForm.setStartTime(KRForm.getStartTime6());
					KRSForm.setEndTime(KRForm.getEndTime6());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA6());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB6());
					KRSForm.setVacationDiv(KRForm.getVacationDiv6());
					KRSForm.setRemark(KRForm.getRemark6());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv7.equals("0")) || query7.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD7());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv7());
					KRSForm.setStartTime(KRForm.getStartTime7());
					KRSForm.setEndTime(KRForm.getEndTime7());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA7());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB7());
					KRSForm.setVacationDiv(KRForm.getVacationDiv7());
					KRSForm.setRemark(KRForm.getRemark7());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv8.equals("0")) || query8.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD8());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv8());
					KRSForm.setStartTime(KRForm.getStartTime8());
					KRSForm.setEndTime(KRForm.getEndTime8());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA8());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB8());
					KRSForm.setVacationDiv(KRForm.getVacationDiv8());
					KRSForm.setRemark(KRForm.getRemark8());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv9.equals("0")) || query9.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD9());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv9());
					KRSForm.setStartTime(KRForm.getStartTime9());
					KRSForm.setEndTime(KRForm.getEndTime9());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA9());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB9());
					KRSForm.setVacationDiv(KRForm.getVacationDiv9());
					KRSForm.setRemark(KRForm.getRemark9());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv10.equals("0")) || query10.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD10());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv10());
					KRSForm.setStartTime(KRForm.getStartTime10());
					KRSForm.setEndTime(KRForm.getEndTime10());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA10());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB10());
					KRSForm.setVacationDiv(KRForm.getVacationDiv10());
					KRSForm.setRemark(KRForm.getRemark10());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv11.equals("0")) || query11.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD11());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv11());
					KRSForm.setStartTime(KRForm.getStartTime11());
					KRSForm.setEndTime(KRForm.getEndTime11());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA11());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB11());
					KRSForm.setVacationDiv(KRForm.getVacationDiv11());
					KRSForm.setRemark(KRForm.getRemark11());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv12.equals("0")) || query12.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD12());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv12());
					KRSForm.setStartTime(KRForm.getStartTime12());
					KRSForm.setEndTime(KRForm.getEndTime12());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA12());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB12());
					KRSForm.setVacationDiv(KRForm.getVacationDiv12());
					KRSForm.setRemark(KRForm.getRemark12());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv13.equals("0")) || query13.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD13());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv13());
					KRSForm.setStartTime(KRForm.getStartTime13());
					KRSForm.setEndTime(KRForm.getEndTime13());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA13());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB13());
					KRSForm.setVacationDiv(KRForm.getVacationDiv13());
					KRSForm.setRemark(KRForm.getRemark13());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv14.equals("0")) || query14.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD14());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv14());
					KRSForm.setStartTime(KRForm.getStartTime14());
					KRSForm.setEndTime(KRForm.getEndTime14());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA14());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB14());
					KRSForm.setVacationDiv(KRForm.getVacationDiv14());
					KRSForm.setRemark(KRForm.getRemark14());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv15.equals("0")) || query15.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD15());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv15());
					KRSForm.setStartTime(KRForm.getStartTime15());
					KRSForm.setEndTime(KRForm.getEndTime15());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA15());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB15());
					KRSForm.setVacationDiv(KRForm.getVacationDiv15());
					KRSForm.setRemark(KRForm.getRemark15());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv16.equals("0")) || query16.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD16());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv16());
					KRSForm.setStartTime(KRForm.getStartTime16());
					KRSForm.setEndTime(KRForm.getEndTime16());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA16());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB16());
					KRSForm.setVacationDiv(KRForm.getVacationDiv16());
					KRSForm.setRemark(KRForm.getRemark16());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv17.equals("0")) || query17.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD17());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv17());
					KRSForm.setStartTime(KRForm.getStartTime17());
					KRSForm.setEndTime(KRForm.getEndTime17());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA17());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB17());
					KRSForm.setVacationDiv(KRForm.getVacationDiv17());
					KRSForm.setRemark(KRForm.getRemark17());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv18.equals("0")) || query18.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD18());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv18());
					KRSForm.setStartTime(KRForm.getStartTime18());
					KRSForm.setEndTime(KRForm.getEndTime18());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA18());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB18());
					KRSForm.setVacationDiv(KRForm.getVacationDiv18());
					KRSForm.setRemark(KRForm.getRemark18());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv19.equals("0")) || query19.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD19());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv19());
					KRSForm.setStartTime(KRForm.getStartTime19());
					KRSForm.setEndTime(KRForm.getEndTime19());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA19());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB19());
					KRSForm.setVacationDiv(KRForm.getVacationDiv19());
					KRSForm.setRemark(KRForm.getRemark19());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv20.equals("0")) || query20.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD20());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv20());
					KRSForm.setStartTime(KRForm.getStartTime20());
					KRSForm.setEndTime(KRForm.getEndTime20());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA20());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB20());
					KRSForm.setVacationDiv(KRForm.getVacationDiv20());
					KRSForm.setRemark(KRForm.getRemark20());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv21.equals("0")) || query21.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD21());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv21());
					KRSForm.setStartTime(KRForm.getStartTime21());
					KRSForm.setEndTime(KRForm.getEndTime21());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA21());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB21());
					KRSForm.setVacationDiv(KRForm.getVacationDiv21());
					KRSForm.setRemark(KRForm.getRemark21());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv22.equals("0")) || query22.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD22());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv22());
					KRSForm.setStartTime(KRForm.getStartTime22());
					KRSForm.setEndTime(KRForm.getEndTime22());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA22());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB22());
					KRSForm.setVacationDiv(KRForm.getVacationDiv22());
					KRSForm.setRemark(KRForm.getRemark22());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv23.equals("0")) || query23.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD23());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv23());
					KRSForm.setStartTime(KRForm.getStartTime23());
					KRSForm.setEndTime(KRForm.getEndTime23());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA23());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB23());
					KRSForm.setVacationDiv(KRForm.getVacationDiv23());
					KRSForm.setRemark(KRForm.getRemark23());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv24.equals("0")) || query24.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD24());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv24());
					KRSForm.setStartTime(KRForm.getStartTime24());
					KRSForm.setEndTime(KRForm.getEndTime24());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA24());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB24());
					KRSForm.setVacationDiv(KRForm.getVacationDiv24());
					KRSForm.setRemark(KRForm.getRemark24());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv25.equals("0")) || query25.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD25());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv25());
					KRSForm.setStartTime(KRForm.getStartTime25());
					KRSForm.setEndTime(KRForm.getEndTime25());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA25());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB25());
					KRSForm.setVacationDiv(KRForm.getVacationDiv25());
					KRSForm.setRemark(KRForm.getRemark25());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv26.equals("0")) || query26.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD26());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv26());
					KRSForm.setStartTime(KRForm.getStartTime26());
					KRSForm.setEndTime(KRForm.getEndTime26());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA26());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB26());
					KRSForm.setVacationDiv(KRForm.getVacationDiv26());
					KRSForm.setRemark(KRForm.getRemark26());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv27.equals("0")) || query27.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD27());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv27());
					KRSForm.setStartTime(KRForm.getStartTime27());
					KRSForm.setEndTime(KRForm.getEndTime27());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA27());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB27());
					KRSForm.setVacationDiv(KRForm.getVacationDiv27());
					KRSForm.setRemark(KRForm.getRemark27());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv28.equals("0")) || query28.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD28());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv28());
					KRSForm.setStartTime(KRForm.getStartTime28());
					KRSForm.setEndTime(KRForm.getEndTime28());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA28());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB28());
					KRSForm.setVacationDiv(KRForm.getVacationDiv28());
					KRSForm.setRemark(KRForm.getRemark28());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv29.equals("0")) || query29.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD29());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv29());
					KRSForm.setStartTime(KRForm.getStartTime29());
					KRSForm.setEndTime(KRForm.getEndTime29());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA29());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB29());
					KRSForm.setVacationDiv(KRForm.getVacationDiv29());
					KRSForm.setRemark(KRForm.getRemark29());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv30.equals("0")) || query30.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD30());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv30());
					KRSForm.setStartTime(KRForm.getStartTime30());
					KRSForm.setEndTime(KRForm.getEndTime30());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA30());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB30());
					KRSForm.setVacationDiv(KRForm.getVacationDiv30());
					KRSForm.setRemark(KRForm.getRemark30());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
				...
				if(!(holidayDiv31.equals("0")) || query31.length() > 1){
					...
					//ゲッターでKRFormのフィールド変数を取得し、それとセッターでKRSFormのフィールド変数を更新
					KRSForm.setKintaiYMD(KRForm.getKintaiYMD31());
					KRSForm.setHolidayDiv(KRForm.getHolidayDiv31());
					KRSForm.setStartTime(KRForm.getStartTime31());
					KRSForm.setEndTime(KRForm.getEndTime31());
					KRSForm.setBreakTimeA(KRForm.getBreakTimeA31());
					KRSForm.setBreakTimeB(KRForm.getBreakTimeB31());
					KRSForm.setVacationDiv(KRForm.getVacationDiv31());
					KRSForm.setRemark(KRForm.getRemark31());
					//インスタンスのフィールド変数が更新された状態で保存処理を実行
					forward = save(KRSForm);
				}
				//StringBufferの中身を削除する
