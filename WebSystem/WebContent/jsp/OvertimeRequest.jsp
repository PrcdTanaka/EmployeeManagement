...
<html:form action="/KinmuRecordAction" method="post">
	<body>
		...
		<!-- 工番名と作業名を入力するテーブル -->
		<table class="workName" border="1" align = "center" style="border-collapse: collapse">
			<tr bgcolor="#b0c4de">
				<th class="workNameHead"></th>
				<th class="workNameHead">工番</th>
				<th class="workNameHead">作業名</th>
			</tr>
			<tr>
				<td>168.00</td>
				<td>144.00</td>
