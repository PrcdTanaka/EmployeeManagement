...
<div class="form-wrapper">
	...
	<body>
		<div align="right">
			<a href="公開情報編集画面.html">公開情報編集へ</a>
		</div>
		<form action="公開情報編集画面.html" method="post">
			<div class="hire_date">
			...
			<div class="birth">
				...
				<input type="text" id="birth" name="birth" size="3">年</input>
				<input type="text" id="birth" name="birth" size="1">月</input>
				<input type="text" id="birth" name="birth" size="1">日</input>
			</div>
			<div class="sex">
			...
			<div class="emergency_contact" id="emergency_contact">
				...
				<p class="emergency_contact" id="emergency_contact3">
					<div>
						<label for="emergency_name3" name="emergency3">氏名：</label>
				...
				<p class="emergency_contact" id="emergency_contact4">
					<div>
						<label for="emergency_name4" name="emergency4">氏名：</label>
				...
				<p class="emergency_contact" id="emergency_contact5">
					<div>
						<label for="emergency_name5" name="emergency5">氏名：</label>
			...
			<div class="family_structure" id="family_structure" >
				...
				<div>
					...
					<input type="text"  class="family_structure_birth"  id="family_structure_birth1" name="family_structure1" size="4">年</input>
					<input type="text"  class="family_structure_birth"  id="family_structure_birth1" name="family_structure1" size="2">月</input>
					<input type="text"  class="family_structure_birth"  id="family_structure_birth1" name="family_structure1" size="2">日</input>
				</div>
				<div>
				...
				<div>
					<label for="family_structure_relationship1" name="family_structure1">続柄：</label>
			...
			<div class="modoru">
				<input type="submit" class="btn" id="button" value="編集/登録">
			</div>
				<p>	確認書類</p>
				<div id="document">
		...
		<input type="button" class="btn" value="戻る" onclick="location.href='メイン画面.html'"></input>
</div>
</html>